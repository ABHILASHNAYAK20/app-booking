    ...
    <form className='flex flex-col gap-5' onSubmit={onSubmit}>
        ...
        <div className='flex flex-col md:flex-row gap-5'>
          <label className='text-gray-700 text-sm font-bold flex-1'>
            ...
            {errors.firstName&&(
                <span className=' text-red-500 font-light'>{errors.firstName.message}</span>
            )}
          </label>
          <label className='text-gray-700 text-sm font-bold flex-1'>
           Last Name
            ...
            {errors.lastName && (
            <span className="text-red-500 font-light">{errors.lastName.message}</span>
          )}
          </label>
        </div>
        <label className='text-gray-700 text-sm font-bold flex-1'>
        ...
        <label className='text-gray-700 text-sm font-bold flex-1'>
          ...
          <span className="text-red-500 font-light">{errors.confirmPassword.message}</span>
        )}
          </label>
          <span>
            <button  
