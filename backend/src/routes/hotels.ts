...
router.post("/:hotelId/bookings/payment-intent", verifyToken, async (req: Request, res: Response) => {
  ...
  const hotelId = req.params.hotelId; // Make sure this is extracted correctly

  // Ensure hotelId is being correctly assigned and used
  console.log({ hotelId }); // Log to verify
